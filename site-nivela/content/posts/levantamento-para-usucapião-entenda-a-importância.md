...
draft: false
---
## Levantamento para usucapião: por que ele é importante?

O levantamento para usucapião é importante porque permite representar tecnicamente o imóvel conforme sua situação física, definindo localização, limites, dimensões e área que serão utilizados na documentação do procedimento. Na usucapião extrajudicial, a legislação prevê a apresentação de planta e memorial descritivo assinados por profissional legalmente habilitado, com a respectiva responsabilidade técnica.
...
Para o processo, não basta simplesmente afirmar onde termina o imóvel. É necessário transformar a realidade física em uma representação técnica que possa ser analisada junto à documentação.

## O que é feito no levantamento para usucapião?

O levantamento tem como objetivo obter os dados necessários para representar tecnicamente o imóvel. Dependendo das características do caso, podem ser analisados elementos como:
...
* relação entre a ocupação existente e os documentos disponíveis;
* informações necessárias para a elaboração da planta e do memorial descritivo.

O resultado não é apenas um desenho.
 O levantamento produz uma base técnica para que a situação física existente seja documentada de maneira objetiva.
...
## O que pode acontecer quando a descrição do imóvel não corresponde à realidade?
...
Significa que existe uma informação que precisa ser analisada tecnicamente.

Outro cenário possível é a existência de uma cerca ou muro antigo que não coincide com os limites indicados em documentos. Também pode haver diferenças entre medidas de documentos antigos e as dimensões verificadas no levantamento.

Nessas situações, o levantamento ajuda a transformar a dúvida em informação mensurável.

A partir daí, advogado, proprietário e demais profissionais envolvidos podem avaliar quais providências são adequadas ao caso concreto.

## Por que o levantamento técnico reduz retrabalho?
...
O objetivo não é presumir que toda divergência representa uma irregularidade.
...
* **Análise jurídica e registral:** A documentação técnica não substitui a análise jurídica. O advogado responsável pelo caso deverá avaliar a modalidade de usucapião, os requisitos legais e a estratégia adequada ao procedimento. No caso da via extrajudicial, o pedido é processado perante o Registro de Imóveis competente e deve ser instruído conforme a legislação e as normas aplicáveis.

## Usucapião extrajudicial exige planta e memorial?

Sim, a legislação prevê planta e memorial descritivo assinados por profissional legalmente habilitado para o procedimento de reconhecimento extrajudicial, observadas as regras e situações previstas na legislação e nas normas registrais.

A Lei nº 6.015/1973, em seu art. 216-A, prevê também a atuação de advogado e a apresentação de outros documentos, incluindo ata notarial.

O Conselho Nacional de Justiça regulamenta os procedimentos extrajudiciais por meio do Código Nacional de Normas da Corregedoria Nacional de Justiça — Foro Extrajudicial, instituído pelo Provimento nº 149/2023 e posteriormente alterado.

Por isso, a documentação deve ser preparada considerando não apenas a situação do terreno, mas também o procedimento aplicável e as exigências do registro competente.

## O que garante a confiabilidade do levantamento?

Um levantamento tecnicamente confiável depende de mais do que coletar medidas.

### Método de levantamento:

A escolha do método deve ser compatível com as características do imóvel e com a finalidade da documentação.

### Controle e validação das medições:

As medições precisam ser verificadas para reduzir inconsistências e evitar que um erro de campo seja levado para a planta ou para o memorial.

### Sistema de referência:

Quando aplicável ao trabalho, a utilização de referências técnicas adequadas permite que as informações territoriais sejam tratadas de maneira consistente.

### Rastreabilidade:

Os dados precisam permitir compreender como a informação apresentada na documentação foi obtida.

### Responsabilidade técnica:

A documentação elaborada por profissional habilitado deve observar a responsabilidade técnica correspondente à atividade realizada.

O contexto técnico da Nivela estabelece como diferencial a validação das medições e o suporte das entregas em normas técnicas aplicáveis, tratando o levantamento como uma atividade técnica que precisa ser controlada e não apenas como uma rotina de medição. Entre as referências utilizadas pela empresa estão a ABNT NBR 13.133, a ABNT NBR 14.166 e o Sistema Geodésico Brasileiro, com SIRGAS2000.

## Quando é recomendável contratar ajuda técnica?

Alguns sinais indicam que uma avaliação técnica pode ser importante antes de avançar com a documentação:

* a área ocupada não parece coincidir com a área dos documentos;
* os limites físicos não estão claramente definidos;
* existem cercas, muros ou outras divisas cuja origem é desconhecida;
* há diferença entre medidas encontradas em documentos;
* a matrícula apresenta descrição antiga ou pouco detalhada;
* os confrontantes não estão claramente identificados;
* existem plantas anteriores com informações diferentes;
* o imóvel possui configuração que exige uma representação técnica mais detalhada.

O proprietário pode reunir seus documentos e apresentar as informações disponíveis.

Já a definição técnica dos limites, a realização do levantamento, o processamento das medições e a elaboração da documentação técnica devem ser avaliados por profissional habilitado.

Também é importante separar as responsabilidades: o profissional responsável pelo levantamento atua na dimensão técnica do imóvel, enquanto a análise jurídica da usucapião cabe ao profissional do Direito responsável pelo caso.
...
## Quem pode fazer o levantamento para usucapião?
...
### Entre em contato com a Nivela para avaliar a demanda de levantamento e memorial descritivo para usucapião.

Para uma triagem inicial, envie as informações disponíveis sobre o imóvel, sua localização e os documentos que já possui. A análise do material permitirá identificar quais informações técnicas precisam ser levantadas e quais pontos devem ser avaliados antes da elaboração da documentação.
